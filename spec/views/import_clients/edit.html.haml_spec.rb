...
describe "import_clients/edit.html.haml" do
  before(:each) do
  ...
  it "renders the edit import_client form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => import_clients_path(@import_client), :method => "post" do
